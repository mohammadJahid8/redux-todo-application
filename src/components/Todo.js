    ...
    return (
        <div className="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0">
            ...
            <div
                ...
                className={`flex-shrink-0 h-4 w-4 rounded-full border-2 ml-auto cursor-pointer hover:bg-green-500 border-green-500 ${color === "green" && "  bg-green-500"}`}></div>

            <div
                onClick={() => handleColorSelected(id, "yellow")}
                className={`flex-shrink-0 h-4 w-4 rounded-full border-2 ml-auto hover:bg-yellow-500 cursor-pointer border-yellow-500 ${color === "yellow" && "  bg-yellow-500"}`}></div>

            <div
                onClick={() => handleColorSelected(id, "red")}
                className={`flex-shrink-0 h-4 w-4 rounded-full border-2 ml-auto hover:bg-red-500 cursor-pointer border-red-500 ${color === "red" && "  bg-red-500"}`}></div>
